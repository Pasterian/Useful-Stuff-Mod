...
public class YellowShardOre extends Block {

	public YellowShardOre(Material mat){
		super(mat);
		this.setHarvestLevel("pickaxe", 1);
		this.setBlockName("yellowshardOre");
		this.setCreativeTab(UMCreativeTabs.usefulStuffTabBlocks);
		this.setStepSound(Block.soundTypeStone);
		this.setHardness(2.0F);
		this.setBlockTextureName("pasterian" + ":" + "yellowShardOre");
	}

	public Item getItemDropped(int par1, Random rand, int par2){
		return UMItems.yellowShard;
	}
